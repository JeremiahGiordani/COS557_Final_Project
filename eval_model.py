...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_set, batch_size=8, shuffle=True, collate_fn=variable_length_collate, num_workers=0)
    val_loader = DataLoader(val_set, batch_size=8, collate_fn=variable_length_collate, num_workers=0)
    test_loader = DataLoader(test_set, batch_size=8, collate_fn=variable_length_collate, num_workers=0)
