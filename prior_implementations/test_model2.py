...
model = TARRevisionClassifier(pretrained=True, use_attention_pooling=True)
...
model_path = "attention_pooling.pt"
model.fit(train_loader, val_loader, epochs=5, optimizer=optimizer, criterion=criterion, device=device, model_path=model_path)
